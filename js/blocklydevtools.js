(window["webpackJsonpGUI"] = window["webpackJsonpGUI"] || []).push([["blocklydevtools"],{

/***/ "./node_modules/.pnpm/css-loader@1.0.1_webpack@4.47.0_webpack-cli@3.3.12_/node_modules/css-loader/index.js!./src/addons/addons/blocklydevtools/style.css":
/*!******************************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/css-loader@1.0.1_webpack@4.47.0_webpack-cli@3.3.12_/node_modules/css-loader!./src/addons/addons/blocklydevtools/style.css ***!
  \******************************************************************************************************************************************************/
...
/***/ "./src/addons/addons/blocklydevtools/_runtime_entry.js":
/*!*************************************************************!*\
  !*** ./src/addons/addons/blocklydevtools/_runtime_entry.js ***!
  \*************************************************************/
...
/* harmony import */ var _userscript_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./userscript.js */ "./src/addons/addons/blocklydevtools/userscript.js");
/* harmony import */ var _css_loader_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! css-loader!./style.css */ "./node_modules/.pnpm/css-loader@1.0.1_webpack@4.47.0_webpack-cli@3.3.12_/node_modules/css-loader/index.js!./src/addons/addons/blocklydevtools/style.css");
...
/***/ "./src/addons/addons/blocklydevtools/userscript.js":
/*!*********************************************************!*\
  !*** ./src/addons/addons/blocklydevtools/userscript.js ***!
  \*********************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  while (true) {
    //Loop necessary for ScratchAddons
    ...
    if (!Blockly) {
      //If the Blockly global is not exposed or found manually, the script cannot do anything useful.
    ...
    workspace.addChangeListener(() => {
      //Every time the workspace changes, update the dom variable.
      if (!document.querySelector("g.blocklyDraggable[data-id].blocklyInsertionMarker")) {
        //Blockly will try to serialise insertion markers, which will cause an internal crash.
    ...
    const observerConfig = {
      ...
      attributes: false,
      subtree: true
    }; //Config for MutationObservers.

    const TabManager = {
      //Hacky fix to get the tab key working in the XML editor.
      enableTab: function enableTab(keyEvent) {
        //Call with the key event and a string to insert at the text caret's position
      ...
      insertTab: function insertTab() {
        //Function to insert the tab char
      ...
      blockKeyEvent: function blockKeyEvent(keyEvent) {
    ...
    function formatXml(xml) {
      let innerHTMLMode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      //Utility function to format XML, optionally outputting valid HTML
      var formatted = '',
        indent = '';
      var tab = '\t';
      ...
      if (!innerHTMLMode) {
        ...
        return formatted.substring(1, formatted.length - 3).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\t/g, "&emsp;").replace(/\n/g, "<br>").replace(/ /g, "&nbsp;");
      }
    }
    function getBlocklyWorkspace() {
      //Get the svg workspace
      return document.querySelector("svg.blocklySvg>g.blocklyWorkspace");
    }
    function getBlocklyBlockCanvas() {
      //get the block canvas from the workspace
      return getBlocklyWorkspace().querySelector("g.blocklyBlockCanvas");
    }
    function getSvgPathFromBlock(blockElem) {
      //Get the svg path from an svg block
    ...
    function isNewBlocklyBlock(node) {
      //Is node a block svg that has not yet been hooked.
    ...
    function makeXMLEditor(blockId, block, devWrapper) {
      //Make the XML editor for a blockId
      function getXmlFromBlockId(id, dom) {
        //Utility function to get the block's XML string from a Blockly serialised DOM.
      ...
      function getXmlFromVarId(id, dom) {
        //Utility function to get the block's XML string from a Blockly serialised DOM.
      ...
      firefoxSpacingFix(container);
      function update() {
        //Function called when the workspace updates
        originalXml = getXmlFromBlockId(blockId, dom); //Update original XML
        if (!originalXml) {
          //If it is now undefined, the block has been deleted or no longer exists, so remove listeners and exit.
      ...
      container.save = function () {
        ...
        if (!xmlStr.includes(originalXml)) {
          //If the domn does not contain the original block XML, it is impossible to save changes.
    ...
    function processBlock(element) {
      //Function to hook block svg element
      if (isNewBlocklyBlock(element)) {
        var _internalBlock;
        //Check if we have not already hooked it
        ...
        (_internalBlock = internalBlock).tooltip || (_internalBlock.tooltip = internalBlock.type || "unknown"); //If the block does not have a tooltip, set it to it's opcode.
        ...
        btn.addEventListener("pointerdown", event => {
          ...
          if (element.hasAttribute("data-id")) {
            ...
            if (devWrapper.querySelector("div[data-isblocklydeveditor]")) {
              //If the editor exists, remove it.
        ...
        var updateObserver = new MutationObserver(function () {
          //When this block updates
          blockId = element.getAttribute("data-id");
          bbox = path.getBBox();
          devWrapper.setAttributeNS(null, "class", "blocklyText");
          devWrapper.setAttributeNS(null, "y", "0");
    ...
    function mutationHandler(mutationRecords) {
      //Handler that tries to process all blocks every time the block canvas changes.
...
//# sourceMappingURL=blocklydevtools.js.map